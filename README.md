...
This is a forked quinglong branch of sliders-windows modified to run with sdxl v-pred models. 
Original had that code ommited for sdxl. Basically added passing v_pred to schedulers and specify guidance rescale value. Tested on imagesliders. Textsliders were modified same way retroactively, didn't check it yet. 
